...
class TestSquareDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_square(self):
        """Ensure models/square.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_rectangle(self):
        """Ensure tests/test_models/test_square.py conforms to PEP8"""
        pep8style = pep8.StyleGuide(quiet=True)
    ...
    def test_class_docstring(self):
        """Check for the presence of a class docstring"""
        self.assertTrue(len(Square.__doc__) >= 1)
...
class TestSquare(unittest.TestCase):
    ...
    def test_id(self):
        """Check if ID is functioning correctly"""
    ...
    def test_size(self):
        """Check if size is functioning correctly"""
    ...
    def test_height(self):
        """Check if height is functioning correctly"""
    ...
    def test_x(self):
        """Check if x is functioning correctly"""
    ...
    def test_y(self):
        """Check if y is functioning correctly"""
    ...
    def test_mandatory_size(self):
        """Confirm that width is a required argument"""
        with self.assertRaises(TypeError):
            s = Square()

    def test_size_typeerror(self):
        """Check for non-integer values for size"""
    ...
    def test_x_typeerror(self):
        """Check for non-integer values for x"""
    ...
    def test_y_typeerror(self):
        """Check for non-integer values for y"""
    ...
    def test_size_valueerror(self):
        """Check for integers less than or equal to 0 for size"""
    ...
    def test_x_valueerror(self):
        """Check for integers less than 0 for x"""
        with self.assertRaisesRegex(ValueError, "x must be >= 0"):
            s = Square(1, -1)

    def test_y_valueerror(self):
        """Check for integers less than or equal to 0 for y"""
    ...
    def test_display_too_many_args(self):
        """Check display with too many arguments"""
        with self.assertRaises(TypeError):
            self.s1.display(1)
    ...
    def test_display_xy(self):
        """Check the display method with x and y"""
        with io.StringIO() as buf, redirect_stdout(buf):
            self.s2.display()
            output = buf.getvalue()
    ...
    def test_update_args_setter(self):
        """Check that the update method uses setter with *args"""
        s = Square(1, 0, 0, 1)
        with self.assertRaises(TypeError):
            s.update(1, "hello")
        with self.assertRaises(TypeError):
    ...
    def test_update_too_many_args(self):
        """check too many args for update"""
        s = Square(1, 0, 0, 1)
        s.update(1, 1, 1, 1, 2)
        self.assertEqual(str(s), "[Square] (1) 1/1 - 1")

    def test_update_no_args(self):
        """Check for too many arguments for update"""
        s = Square(1, 0, 0, 1)
        s.update()
        self.assertEqual(str(s), "[Square] (1) 0/0 - 1")
    ...
    def test_update_kwargs_setter(self):
        """check that the update method uses setter with **kwargs"""
        s = Square(1, 1, 1, 1)
        with self.assertRaises(TypeError):
            s.update(size="hello")
        with self.assertRaises(TypeError):
    ...
    def test_mix_args_kwargs(self):
        """checks output for mixed args and kwargs"""
        s = Square(1, 0, 0, 1)
        s.update(2, 2, 2, 2, size=3, x=3, y=3, id=3)
        self.assertEqual(str(s), "[Square] (2) 2/2 - 2")

    def test_extra_kwargs(self):
        """check for random kwargs"""
        s = Square(1, 0, 0, 1)
        s.update(hello=2)
        self.assertEqual(str(s), "[Square] (1) 0/0 - 1")

    def test_to_dict(self):
        """Check regular to_dictionary"""
    ...
    def test_save_to_file(self):
        """Check the regular use of save_to_file"""
        s1 = Square(1, 1, 1, 1)
        s2 = Square(2, 2, 2, 2)
        l = [s1, s2]
    ...
    def test_stf_empty(self):
        """Check save_to_file with an empty list"""
        l = []
        Square.save_to_file(l)
        with open("Square.json", "r") as f:
    ...
    def test_load_from_file(self):
        """Check normal use of load_from_file"""
        s1 = Square(2, 3, 4, 5)
        s2 = Square(7, 8, 9, 10)
        li = [s1, s2]
